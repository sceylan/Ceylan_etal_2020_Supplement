...
class Recalibration(NonSeismicEvent):
    ...
    def read_waveforms(self):
        ...
        start_time = obspy.UTCDateTime("2019-07-27T10:30:00.0Z")
        end_time = obspy.UTCDateTime("2019-07-27T11:30:00.0Z")
    ...
    def plot(self):
        ...
        ax1.text(10, 4, 'VBB-Z', color='white', fontweight='bold', fontsize=8)
        fig.text(0.15, 0.72, '2019-07-27\n10:30', fontsize=6)
        fig.text(0.78, 0.72, '2019-07-27\n11:30', fontsize=6)
...
# Run the example
sol = utils.utc2sol(obspy.UTCDateTime('2019-07-27T10:30:00.0Z'))
Recalibration(sol=sol).plot()