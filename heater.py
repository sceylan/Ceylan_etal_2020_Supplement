...
class Heater(NonSeismicEvent):
    ...
    def read_waveforms(self):
        ...
        start_time = obspy.UTCDateTime("2019-10-21T17:50:00.0Z")
        end_time = obspy.UTCDateTime("2019-10-21T18:15:00.0Z")
    ...
    def plot(self):
        ...
        p, f, t = utils.specgram(
            data=spect_comp.data, f_samp=20, winlen=1024, overlap=0.6)
...
# Run the example
sol = utils.utc2sol(obspy.UTCDateTime('2019-10-21T17:50:00.0Z'))
Heater(sol=sol).plot()